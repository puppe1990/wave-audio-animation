...
class TestJobStoreCreate:
    def test_create_generates_uuid4_id(self):
        job = job_store.create(user_id="u1", format="mp4", duration=30, style="bars", aspect_ratio="16:9")
    ...
    def test_create_stores_provided_fields(self):
        job = job_store.create(user_id="u1", format="gif", duration=10, style="line", aspect_ratio="9:16")
...
class TestJobStoreGet:
    def test_get_returns_existing_job(self):
        created = job_store.create(user_id="u1", format="mp4", duration=30, style="bars", aspect_ratio="16:9")
...
class TestJobStoreUpdate:
    ...
    def test_update_changes_file_paths(self):
        job = job_store.create(user_id="u1", format="mp4", duration=30, style="bars", aspect_ratio="16:9")
        updated = job_store.update(job.id, audio_file_path="/tmp/input.wav", output_file_path="/tmp/output.mp4")
        assert updated is not None
...
class TestJobStoreListByUser:
    def test_list_returns_only_that_users_jobs(self):
        job_u1 = job_store.create(user_id="user_a", format="mp4", duration=30, style="bars", aspect_ratio="16:9")
        job_u2 = job_store.create(user_id="user_b", format="gif", duration=10, style="line", aspect_ratio="1:1")
    ...
    def test_list_sorted_by_created_at_desc(self):
        job1 = job_store.create(user_id="u1", format="mp4", duration=30, style="bars", aspect_ratio="16:9")
        time.sleep(0.01)
        job2 = job_store.create(user_id="u1", format="gif", duration=10, style="line", aspect_ratio="1:1")
...
class TestJobIsolation:
    def test_users_do_not_see_each_others_jobs(self):
        job_store.create(user_id="isolated_u1", format="mp4", duration=30, style="bars", aspect_ratio="16:9")
        job_store.create(user_id="isolated_u1", format="mp4", duration=30, style="bars", aspect_ratio="16:9")
        job_store.create(user_id="isolated_u2", format="gif", duration=10, style="mirror", aspect_ratio="9:16")
